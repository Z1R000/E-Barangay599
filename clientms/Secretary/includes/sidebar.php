...
{               ?>
        ...
        <ul>
            ...
            <li><a class="tooltips" href="change-logo.php"><span>Settings</span><i class="lnr lnr-cog"></i></a></li>
    ...
    <div class="menu">
        <ul id="menu" >
			...
			<li id="menu-academico" ><a href="#"><i class="fa fa-user"></i> <span>Residents</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="create-resident.php"> Add Residents</a></li>
			...
			<li><a href="search-blotter.php"><i class="fa fa-file-text-o"></i> <span>Blotter Record</span></a></li>

            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-lg-6 col-md-8 col-xs-12 col-sm-10 rounded bg-white rounded">
                    ...
                    <div class="row p-3">
                        ...
                        <label for="code" class="fs-5 text-secondary">8 character Reset Code</label>
                        <div class="input-group">

                            <input type="password" class="form-control" name="pas1" id="pas1" placeholder="Reset Code:" required>
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="pas1" id="pas1" placeholder="New Password:" required>
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="pas2" name="pas2" placholder="E-barangay e-mail address" placeholder="Confirm password:" required>

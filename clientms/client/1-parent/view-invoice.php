...
$sql="select distinct tblresident.ContactName,tblresident.Cellphnumber,tblresident.Email,tblresident.AccountID,tblinvoice.BillingId,tblinvoice.PostingDate from  tblresident   
	join tblinvoice on tblresident.ID=tblinvoice.Userid  where tblinvoice.BillingId=:invid";
...
<tr>
<th colspan="8">Resident Details</th>	
</tr>
							 <tr> 
								<th>Contact Name</th> 

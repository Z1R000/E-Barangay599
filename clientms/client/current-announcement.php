        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Current Announcement</h2>
            ...
            <div class="sub-heard-part">
                <ol class="breadcrumb m-b-0"style="text-indent: 15px; margin-left: 2.5%;">
                    ...
                    <li class="active">Current Announcement</li>
                </ol>
            </div>


            <div class="container-fluid px-4">
                <div style="background-color: aliceblue;border-radius: 25px;overflow: hidden;">
                    <h1 style="float: left; margin:25px;    color: #021f4e;">Announcement</h2>
                        ...
                        <br><br><br>
                        <div class="testulit" style="border-radius: 25px;overflow: hidden;">
                        <h2 style="text-align: justify; margin:25px; text-indent: 10%;">Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. Announcement Sample. </h2>
                        </div>

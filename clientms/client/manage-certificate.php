                        ...
                        <div class = "row my-2">
                            <div class="col-md-8">
                                ...
                                <div class="btn-group" role="group">
                                    <a href = "resident-registration.php"  class="btn btn-outline-primary mx-1 my-1"><i class="fa fa-plus"></i>&nbsp;New Certificate Request</a>
                                </div>
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $row) {               ?>
                                                <tr class="active">
                                                    ...
                                                    <td style="color: #000;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="btn-group me-1 mb-1" role="group" aria-label="First group">
                                                            <button type="submit" type="button" class="btn btng btn-primary">File Upload</button>
                                                        </div>
                                                    </td>
                                                    <td>

...
<html>
<head>
<title>Certificate Request Record</title>
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Certificate Request Record</li>
						</ol>
					</div>
...
{               ?>
									     <tr class="active">
									        ...
									        <td><a href="edit-certificate-request.php?editid=<?php echo $row->ID;?>" style="color: red; text-decoration: underline;">Delete Request</a></td>
									     </tr>

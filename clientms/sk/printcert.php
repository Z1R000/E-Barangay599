...
if (strlen($_SESSION['clientmsaid']==0)) {
  header('location:logout.php');
	...
	join tblcreatecertificate on tblresident.ID=tblcreatecertificate.Userid  where tblcreatecertificate.CreationId=:sid";
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li><a href="view-certification.php?creationid=<?php echo $row->CreationId;?>">View Certification</a></li>

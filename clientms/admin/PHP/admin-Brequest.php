...
<body>
    ...
    ?>
                            ...
                            <div class="col-md-4 mt-2 mx-0">
                                ...
                                <div class ="nav justify-content-end mx-0">
                                    ...
                                    <div class="btn-group" role="group">
                                        <a href = "admin-blotter.php"  class="btn btn-primary mx-1 my-1"><i class="fa fa-list"></i>&nbsp; Records</a>
                                    </div>
                        ...
                        <div class="col">
                            <table class = "table">
                                <thead style= "background:#021f4e">
                                    <tr>
                                        <td colspan = 7 class = "" style = "color: white" align = "center">Blotter Requests</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class = "light">
                                    ...
                                    <tr>
                                        ...
                                        <td class = "">
                                            Nag cripwalk sa gitna ng kalsada 
                                        </td>
                                             
                            
                                        <td>
                                            <div class = "actions" align = "center">
                                                    <a href="#approve" class="btn btn-primary text-decoration-none my-1" data-bs-toggle = "modal" data-bs-dismiss= "modal"role = "button"><i class = "fa fa-edit"></i>&nbsp;<span id = "label">Approve</span></a>
        ...
        <div class="modal fade  " id = "approve" tab-idndex = "-1">
            <div class="modal-dialog modal-dialog-centered modal-md border-danger">

...
<head>
    ...
    <title>Other Services Records</title>
...
<body>
        <div class = "container-fluid  ">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 mb-3">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Other Service Records</h2>
                </div>
                ...
                <nav aria-label="breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="admin-otherservice.php"><i class="fa fa-file"></i>&nbsp; Other Services</a></li>
            ...
            <div class="row">
                        ...
                        <div class="col-lg-3  mx-0 justify-content-end ">
                                <div class = "row justify-content-end">
                                    <a href = "#add-walkin-cer" class="btn btn-primary mx-1 my-1" data-bs-toggle = "modal" role = "button"><i class="fa fa-plus"></i>&nbsp;Walk in Service</a>
                                </div>
                        </div>
            ...
            <div class="row ">    
                    ...
                    <div class="col-xl-4 my-2">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">6</h3>
                                <a class = "link-dark fs-4 card-text" href ="#">Total Declined Service</a>
                            </div>
                    ...
                    <div class="col-xl-4 my-2">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">9</h3>
                                <a class = "link-dark fs-4 card-text" href ="#" >Total Catered Service</a>
                            </div>
                    ...
                    <div class="col-xl-4 my-2">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">2.2</h3>
                                <a class = "link-dark fs-4 card-text" href ="#">Daily Service Rate</a>
                            </div>
                                
                                <i class="fa fa-chart-line fs-1 primary-text border rounded-circle secondary-bg p-3"></i>
    ...
    <div class="modal fade" id="gen-cer"  tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="add-blotter-type"><i class = "fa fa-cog"></i>&nbsp;Service Record</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-6 my-1">
                                    ...
                                    <select class="form-select" aria-label="Default select example" disabled>
                                        ...
                                        <option value="violence">Feeding program</option>
                                        <option value="public" >Marriage</option>
                                        <option value="public" >Seminar</option>
                                        <option value="public" >Wet Market Pass</option>
                            ...
                            <div class="col-xl-6 my-1">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" aria-label="Default select example" disabled>
                                        <option selected disabled>-Reason for service-</option>
    ...
    <div class="modal fade" id="edit-record"  tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="add-blotter-type"><i class = "fa fa-edit"></i>&nbsp;Service Record</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <div class="modal fade" id="add-walkin-cer"  tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="add-blotter-type"><i class = "fa fa-plus"></i>&nbsp;New Service Record</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 my-1">
                                <div class="input-group">
                                    ...
                                    <!--populate with db kaw na populate hahaha galing db-->
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected disabled>-Reason of service-</option>
                                        <option value="violence">For Employment</option>
                                        <option value="public" >For Education</option>
                                        <option value= "vb">For personal reasons</option>
                                        <option value= "vb">Others</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 my-1">
                                    ...
                                    <!--populate with db-->
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected disabled>Settlement tatus</option>
                                        <option value="">Settled</option>
                                        <option value="public" >Unsettled</option>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body px-5">
                    <p class = "fs-4">New service record about to be created,<br>Click "Yes" if certain</p>
                </div>
                <div class="modal-footer">
                    <form method = "POST" action = "#">
                ...
                <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col my-1">
                                        ...
                                        <input type="text" class="form-control"  placeholder="Requested Service"readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

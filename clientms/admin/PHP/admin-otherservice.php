...
<body>
    ...
    ?> 
                ...
                <nav aria-label="breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#"><i class="fa fa-ellipsis-h text-muted"></i></a>&nbsp;<?php echo $curr;?></li>
                        </ol>
                    </nav>
                </nav>
            </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 mt-2 mx-0">
                        <div class ="nav justify-content-end mx-0">
                            ...
                            <div class="btn-group" role="group">
                                <a href = "admin-OSrequest.php"  class="btn btn-primary mx-1 my-1"><i class="fa fa-list"></i>&nbsp;Requests</a>
                            </div>
            ...
            <!--populate this with db data retain template alongside actual data-->
            <div class = "container-fluid">
                ...
                <div class = "row">
                    <div class = "col">
                        <table class = "table">
                            <thead class="table" style = "background: #021f4e" >
                                <tr>
                                    <td colspan = 5 class = "" style = "color: white" align = "center">Other Services</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class = "light">
    ...
    <div class="modal fade" id = "verif-brecord" tab-idndex = "-1">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body px-5">
                    <p class = "fs-4">New service about to be created,<br>Click "Yes" if certain</p>
                </div>
                <div class="modal-footer">
                    <form method = "POST" action = "#">
                    <input type = "button" class="btn btn-success"  name = "yes" value ="Yes">
    ...
    <div class="modal fade" id = "verif-update" tab-idndex = "-1">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body px-5">
                    <p class = "fs-4">Confirm service update<br>Click "Yes" if certain</p>
                </div>
                <div class="modal-footer">
                    <form method = "POST" action = "#">
                    <input type = "button" class="btn btn-success"  name = "yes" value ="Yes">
    ...
    <div class="modal fade" id="edit-service"  tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="add-blotter-type"><i class = "fa fa-edit"></i>&nbsp;Update Service</h5>
                    ...
                    <form method = "POST" action="#">
                        ...
                        <div class="row">
                            <div class="col-md-8 my-1">
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        <div class="input-group-text"><a  disabled><i class ="fa fa-ellipsis-h"></i></a></div>
                                    </div>
    ...
    <div class="modal fade" id="add-service"  tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="add-blotter-type"><i class = "fa fa-plus"></i>&nbsp;New Service</h5>

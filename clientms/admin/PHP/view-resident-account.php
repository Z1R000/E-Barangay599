                    ...
                    <div class="row g-0  rounded-top border bg-white">
                        <div class="col-xl-10 py-2 px-2  ">
                            <nav class="nav nav-pills flex-column  flex-sm-row">
                                ...
                                <a class="flex-sm-fill text-sm-center nav-link active" href="view-resident-account.php">Account Details</a>
                        ...
                        <div class="col-xl-11 mx-2  mx-auto  px-2">
                            ...
                            <table class="table my-3" >
                                    ...
                                    <tr>
                                        ...
                                        <td style ="text-align: right; padding-right: 4%" >123213123</td>
                                    </tr>

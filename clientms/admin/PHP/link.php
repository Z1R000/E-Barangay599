...
DataTable.ext.buttons.print = {
	...
	action: function ( e, dt, button, config ) {
		...
		if(config.repeatingHead.logo) {
			...
			html += '<tr class= ""><th style = "border: 0px none"colspan="'+(data.header.length)+'" style="padding: 0;margin: 0;text-align: '+logoPosition+';"><img style="'+config.repeatingHead.logoStyle+'" src="'+config.repeatingHead.logo+'"/></th></tr>';
		}

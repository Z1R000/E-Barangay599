                            ...
                            <div class="row border border-warning g-0 bg-light shadow-lg pb-4 rounded er">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-xl-3 px-3">
                                        <button type="submit" class="btn btn-danger form-control" name="delete" id="delete">Reject</button>
                                    </div>
                                    <div class="col-xl-3 px-3">

                                        <button type="submit" class="btn btn-success form-control" name="submit" id="submit">Approve</button>

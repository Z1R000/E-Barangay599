<?php 
    ...
    header('location:logout.php');
        ...
        foreach ($result as $r){
            ...
            array_push($arr,$r->Cellphnumber);
            array_push($arr,$r->Email);
            array_push($arr,$r->payment);
...
<body>
    ...
    <div class="container-fluid p-5 ">
        ...
        <div class="row">
            ...
            <?php
            if ($_GET['payment']=="rejected"){
               echo '
               <div class="container" style= "display:block;">
                <div class="row gx-3 bg-danger border-danger text-white">
                    <div class="fs-5">Declined Payment Message</div>
                </div>
                <form method = "POST">
                ...
                <form action="" method = "POST">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input id = "dname" type="text" class="form-control" value = "'.$arr[1].'" readonly>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id = "crs" type="text" class="form-control" value = "'.$arr[7].'" readonly>
               
                                   
                                </div>
                                <div class="col-md-6">
                                    <label for="emails" >Payment Status</label>
                                    <input id = "emails" type="text" class="form-control" value = "PAYMENT REJECTED - '.$arr[15].'" readonly>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input id = "contac" type="text" class="form-control" value = "'.$arr[13].'" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="emails" >Email Address</label>
                                        <input id = "emails" type="text" class="form-control" value = "'.$arr[14].'" readonly>
                ...
                <div class="row mt-2 ms-2 me-3">
                            <form action="" method = "POST">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <label for="emails" >Payment Status</label>
                                        <input id = "emails" type="text" class="form-control" value = "PAYMENT VERIFIED - '.$arr[15].'" readonly>

                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-xl-12" >
                                            ...
                                            <button class="btn btn-secondary disabled">From</button>
                                                <input type="datetime-local" name= "startDur" class="form-control" id="startDur">
                            ...
                            <script>
                                function checkDate() {
                                    var sd = document.getElementById('startDur').value;
                                    var ed = document.getElementById('endDur').value;
                                    if (ed < sd) {
                                        alert("Date must be in the future");
                                        document.getElementById('endDur').value = null;
                                    }
                                }
                            </script>

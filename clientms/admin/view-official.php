...
{               ?>
						<div class="graph-form" style="border: 1px black solid; border-radius: 15px;">
							...
							<tr>
								<td></td><td></td><td></td><td><a href="index.php" name="cancel" id="cancel" style="color: white; background-color: silver; border: 1px; border-radius:25px; width: 60%; padding: 2.5%;" class="btn btn-default"> Delete</a></form></td>
							</tr>
<?php $cnt=$cnt+1;}} ?>
</table>
<br>

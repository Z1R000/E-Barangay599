								...
								<table class="table" border="1"> <thead> <tr> <th>#</th> 
									<th>Invoice Id</th>
									 ...
									 <th>Action</th>
									    ...
									    <tbody>
									    	<?php
$sql="select distinct tblresident.ContactName,tblinvoice.BillingId,tblinvoice.PostingDate from  tblresident   
	join tblinvoice on tblresident.ID=tblinvoice.Userid  where date(tblinvoice.PostingDate) between '$fdate' and '$tdate'";

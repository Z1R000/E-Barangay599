...
<html>
<head>
	<title>Resident List || Purok 9</title>
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Resident List for Purok 9</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Resident List || Purok 9</h3>
							...
							<br>
								...
								<table class="table" border="1"> <thead style="background-color: #021f4e;"> <tr>
									 ...
									 <th><span style="color: #fff;">Setting</th>
									    ...
									    <tbody>
									    	<?php
$sql="SELECT * from tblresident where Purok='9'";

						...
						<div class="graph" style="border-radius: 15px; border: 1px black solid;">
							<div class="tables">
								<table style="border: none; width: 100%; font-size: 120%;">
									...
									<tr>
										<td></td><td></td><td></td>
										<td><center><a href="index.php" name="cancel" id="cancel" style="color: white; background-color: silver; border: 1px; border-radius:25px; width: 60%; padding: 2.5%;" class="btn btn-default"> Delete</a></form></td>
									</tr>
								</table>

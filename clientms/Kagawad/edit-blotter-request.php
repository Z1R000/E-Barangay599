...
<li><a href="blotter-request.php">Blotter Request Record</a></li>
...
{               ?>	
	...
	<table style="border: none; width: 100%; font-size: 120%;">
		...
		<tr>
			...
			<td></td><td></td>
			<td><center><button type="submit" class="btn btn-default" name="submit" id="submit" style="color: white; background-color: #021f4e; border: 1px; width: 50%; border-radius:25px;">Accept</button> </center> </form></td>
		</tr>
		<?php $cnt=$cnt+1;}} ?>
	</table>

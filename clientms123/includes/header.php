...
<img class="1" src="images/barangay.png" style="height: 18%; position: absolute;">
...
<img class="2" src="images/Maynila.png" style=" height: 18%; position: absolute; top: 0%; right: 1%;">
        <!--menu-right-->
        <div class="top_menu">

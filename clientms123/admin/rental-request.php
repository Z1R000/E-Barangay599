...
{               ?>
									     <tr class="active">
									      <th scope="row"><?php  echo htmlentities($row->ID);?></th>
									        <td style="color: black;"><?php  echo htmlentities($row->rentalName);?></td>
											...
											<td style="color: black;"><?php  echo htmlentities($row->Cellphnumber);?></td>
									         ...
									         <td style="color: black;"><?php  echo htmlentities($row->rentalStartDate);?></td>
											 <td style="color: black;"><?php  echo htmlentities($row->rentalEndDate);?></td>

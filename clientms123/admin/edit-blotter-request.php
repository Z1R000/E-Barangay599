...
<li class="active">Edit Blotter Request</li>
</ol>
</div>	
					<!--/sub-heard-part-->	
					<!--/forms-->
<div class="forms-main">
<h2 class="inner-tittle">Edit Blotter Request</h2>
<div class="graph-form">
<div class="form-body">
<form method="post"> 
	<?php
$eid=$_GET['editid'];
$sql="SELECT * from tblblotterrequest where ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>	
	...
	<table style="border: none; width: 100%; font-size: 120%;">
		...
		<tr>
			...
			<th><span style="color: #000;">Resident ID</span></th>
		</tr>
		<tr>
			...
			<td><input type="text" name="td" value="<?php  echo htmlentities($row->userID);?>" placeholder="Report Date" class="form-control" required='true' readonly='true' style="width: 90%;font-size: 90%; color: black;"></td>
		</tr>
		<tr>
			<td><br></br>
		</tr>

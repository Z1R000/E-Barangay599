...
{               ?>
		...
		<tr>
			<td><input type="email" name="email" value="<?php  echo htmlentities($row->Email);?>" placeholder="Email address" class="form-control" required='true' readonly="true" style="width: 90%;font-size: 90%; color: black;"></td>
		</tr>
	</table>
<?php $cnt=$cnt+1;}} ?>

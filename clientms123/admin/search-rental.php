								...
								<thead style="background-color: #021f4e;"><th><span style="color: #fff; font-size:120%;">#</span></th>
									<th><span style="color: #fff; font-size:120%;">Rental Name</th>
									 <th><span style="color: #fff; font-size:120%;">Resident Name</th>
											...
											<th><span style="color: #fff; font-size:120%;">Authorized By Admin ID:</th> 
									     ...
									     <tr class="active">
									      <th scope="row"><span style="color: #00a6ff;"><?php echo htmlentities($cnt);?></th>
										   <td><span style="color: #000;"><?php  echo htmlentities($row->rentalName);?></td>
											...
											<td><span style="color: #000;"><?php  echo htmlentities($row->BarangayPosition);?> <?php  echo htmlentities($row->adminID);?></td>
								...
								<thead style="background-color: #021f4e;"><th><span style="color: #fff; font-size:120%;">#</span></th>
									<th><span style="color: #fff; font-size:120%;">Rental Name</th>
									 <th><span style="color: #fff; font-size:120%;">Resident Name</th>
											<th><span style="color: #fff; font-size:120%;">Contact Number</th> 
											<th><span style="color: #fff; font-size:120%;">Address</th> 
											<th><span style="color: #fff; font-size:120%;">Authorized By:</th> 
									 <th><span style="color: #fff; font-size:120%;">Rental Start Date</th>
									 <th><span style="color: #fff; font-size:120%;">Rental End Date</th>
									  </tr>
									   </thead>

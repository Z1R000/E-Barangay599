...
$newpassword=$_POST['newpassword'];
  $sql ="SELECT Email FROM tblresident WHERE Email=:email and Cellphnumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblresident set Password=:newpassword where Email=:email and Cellphnumber=:mobile";
...
<body>
	<div class="error_page">
		...
		<div class="error-top">
			<h2 class="inner-tittle page">599 Residents</h2>
			<div class="login">

...
$query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Blotter Request Sent.")</script>';
...
<form method="post" style="font-size:1.25em;"> 
	...
	<div class="form-group"> <label for="exampleInputEmail1" style="color: #021f4e;">Respondent/s:</label> <input type="text" name="res" placeholder="Respondent/s Name" value="" class="form-control" required='true' style=" font-size: 0.8em;"> </div>

...
<html>
<head>
<title>Rental Request Record</title>
			...
			<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Rental Request Record</li>
						</ol>
					</div>
...
{               ?>
									     <tr class="active">
									        <td style="color: #000;"><?php  echo htmlentities($row->rentalName);?></td>
											 ...
											 <td><a href="edit-rental-request.php?editid=<?php echo $row->ID;?>" style="color: red; text-decoration: underline;">Edit</a></td>
									     </tr>
									     <?php $cnt=$cnt+1;}} ?>
									     </tbody> </table> 
							</div>
